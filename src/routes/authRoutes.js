...
import { register, login, logout, getUserByFirebaseUid, getUserById, checkUserExistsWithJWT, getPublicProfileBySlug, sendOTP, verifyOTP, forgotPassword } from "../controllers/authController.js";
